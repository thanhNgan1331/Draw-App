...
public class TextView extends AppCompatActivity {
            ...
            toolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
                ...
                public boolean onMenuItemClick(MenuItem item) {
                    if (item.getItemId() == R.id.item_save) {
                        File file = FileUtil.getNewFile(TextView.this, "Sticker");
                        if (file != null) {
                            stickerView.save(file);
                            Toast.makeText(TextView.this, "saved in " + file.getAbsolutePath(),
                                    Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TextView.this, "the file is null", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    public void testReplace(View view) {
        showChange((TextSticker) stickerView.getCurrentSticker());
...
//        }
    ...
    private void showChange(final TextSticker textSticker) {
        final EditText editText = new EditText(this);
                ...
                .setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (stickerView.replace(textSticker)) {
                            Toast.makeText(TextView.this, "Replace Sticker successfully!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(TextView.this, "Replace Sticker failed!", Toast.LENGTH_SHORT).show();
                        }                        // Cập nhật lại StickerView ở đây nếu cần
                    }
                })
                .setNegativeButton("Cancel", null)
                .create()
