...
public class StickerView extends FrameLayout {
    ...
    public boolean replace(@Nullable Sticker sticker, boolean needStayState) {
        if (handlingSticker != null && sticker != null) {
            ...
            if (onStickerOperationListener != null) {
                onStickerOperationListener.onReplace(handlingSticker);
            }
    ...
    public void showChange(@Nullable TextSticker textSticker, StickerView paint) {
        ...
        builder.setTitle("Change Text")
                ...
                .setPositiveButton("Done", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (paint.replace(textSticker)) {
                            Log.d(TAG, "Replace Sticker successfully!");
                        } else {
                            Log.d(TAG, "Replace Sticker failed!");
                        }
                    }
                })
    ...
    public interface OnStickerOperationListener {
        ...
        void onReplace(@NonNull Sticker sticker);
    }
}
